...
运行 `LiveAvatar-Setup-0.1.1.exe`，选择程序目录和数据目录即可。安装器本身约 2.1 MB，不内置模型；所有载荷支持断点续传、固定字节数和 SHA-256 校验。RTX 50/Blackwell 使用 PyTorch 2.11.0 CUDA 12.8。安装、迁移、修复、卸载保留规则见 [安装包说明](docs/INSTALLER.md)。
